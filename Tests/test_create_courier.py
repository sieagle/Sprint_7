...
class TestCreateCourier:
    ...
    @allure.title('Проверка ошибки создания существующего курьера')
    @allure.description('Отправляем 2 запроса на создание с одними и теми же данными')
    ...
    @allure.title('Проверка регистрации без обязательных полей логина/пароля')
    @allure.description('Отправляем запрос ')
